      ...
      <div class="flex justify-between h-16">
         <div class="flex flex-auto justify-between">
            ...
            <div class="hidden lg:ml-6 lg:flex lg:space-x-12">
               ...
               <a href="{{ route('index') }}" class="text-[#1E2B4F] relative {{ request()->is('/') ? " after:absolute
                  after:content-[''] after:border-b-2 after:border-[#0D63F5] after:w-8/12 after:-translate-x-1/2
